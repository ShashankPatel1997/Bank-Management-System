	...
	<div class="container">
		...
		<!-- //nav -->
			...
			<ul class="unlist">
				...
				<li class="list"style="background-color: #ffc168;"><a href="GetStatement">Get Statement</a></li>
...
<%ArrayList al1=(ArrayList)session.getAttribute("al1"); ArrayList al2=(ArrayList)session.getAttribute("al2");%>
<% Iterator itr=al1.iterator(); Iterator itr1=al2.iterator(); %>
<%  out.print("<table><tr><th>Account No</th><th>Amount</th></tr>");
while(itr.hasNext()&&itr1.hasNext()) 
      {  
	    out.print("<tr><td>"+itr.next()+"</td>");
	     out.print("<td>"+itr1.next()+"</td></tr>");
	   }
out.print("</table>");
%>				
