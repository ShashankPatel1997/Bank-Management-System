	...
	<div class="container">
		...
		<!-- //nav -->
			...
			<ul class="unlist">
				...
				<li class="list"><a href="loan.jsp">Apply Loan</a></li>
				<li class="list"><a href="GetStatement">Get Statement</a></li>
				<li class="list"style="background-color: #ffc168;"><a href="changePass.jsp">Change Password</a></li>
...
<!-- products -->
<section style="background-image: linear-gradient(to bottom right,#edf5ef, white);" class="products py-5">
	<div class="container py-lg-2 py-3">
			<div class="container">	
				<!-- banner slider-->
				 <div  class="form">
				...
				<div class="col-lg-8 left-build-wthree aboutright-w3pvtwthree">
					<div class="row">
						...
						<div class="col-sm-4 col-6 w3layouts_stats_left w3_counter_grid2">	
							...
							<p class="counter"><% out.print(customer);%></p>
						...
						<div class="col-sm-4 col-6 w3layouts_stats_left w3_counter_grid1 mt-sm-0 mt-4">
							...
							<p class="counter"><% out.print(deposit);%></p>
							<p class="para-text-w3ls"style="font-weight:bold">Deposits</p>
						</div>
						<div class="col-sm-4 col-6 w3layouts_stats_left w3_counter_grid1 mt-sm-0 mt-4">
							<span class="fa fa-inr"></span>
							<p class="counter"><% out.print(transaction);%></p>
