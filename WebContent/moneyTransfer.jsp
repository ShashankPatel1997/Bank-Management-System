...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <link href="css/moneyform.css" rel='stylesheet' type='text/css' />
	<!-- //css files -->
	...
	<div class="container">
		...
		<!-- //nav -->
			...
			<ul class="unlist">
				...
				<li class="list"style="background-color: #ffc168;"><a href="moneyTransfer.jsp">Money Transfer</a></li>
...
<section class="products py-2">
  ...
  <form action="Transfer">
    ...
    <input type="text"  name="accno1" placeholder="Enter Account number">
