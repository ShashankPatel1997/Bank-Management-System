...
<section class="products py-5">
	<div class="container py-lg-5 py-3">
		<h3 class="heading mb-sm-5 mb-4">Select <strong>loan</strong> that you are interested</h3>
		<div class="row products_grids text-center mt-5">
			...
			<div class="col-md-3 col-6 grid5">
				<div class="prodct1 border p-3">
					<a href="Loan">
						<img src="images/Education-Loan.png" alt="" class="img-fluid">
						<h3 class="mt-2">Educational loan</h3>
						<span class="fa fa-long-arrow-right"></span>
					</a>
				</div>
			</div>
			<div class="col-md-3 col-6 grid6 mt-md-0 mt-3">
				<div class="prodct1 border p-3">
					<a href="Loan">
						<img src="images/Loan-PNG.png" alt="" class="img-fluid">
						<h3 class="mt-2">House loan</h3>
						<span class="fa fa-long-arrow-right"></span>
					</a>
				</div>
			</div>
			<div class="col-md-3 col-6 grid7 mt-md-0 mt-3">
				<div class="prodct1 border p-3">
					<a href="Loan">
						<img src="images/personal-loan-marriage-res.png" alt="" class="img-fluid">
						<h3 class="mt-2">Marriage loan</h3>
						<span class="fa fa-long-arrow-right"></span>
					</a>
				</div>
			</div>
			...
			<div class="col-md-3 col-6 grid7 mt-md-0 mt-3">
				<div class="prodct1 border p-3">
					<a href="Loan">
						<img src="images/CarLoan.png" alt="" class="img-fluid">
						<h3 class="mt-2">Car loan</h3>
						<span class="fa fa-long-arrow-right"></span>
					</a>
				</div>
			</div>
			<div class="col-md-3 col-6 grid7 mt-md-0 mt-3">
				<div class="prodct1 border p-3">
					<a href="Loan">
						<img src="images/AgLoans.png" alt="" class="img-fluid">
						<h3 class="mt-2">Agricultural loan</h3>
						<span class="fa fa-long-arrow-right"></span>
					</a>
				</div>
			</div>
