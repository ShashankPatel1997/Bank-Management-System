...
<header>
	<div class="container">
		...
		<!-- //nav -->
			...
			<ul class="unlist">
				<li class="list"style="background-color: #ffc168;"><a href="CheckBalance">Check Balance</a></li>
...
<section class="products py-5">
	<div class="container py-lg-5 py-3">
		<h3 class="heading mb-sm-3 mb-4"><strong><%out.print(usrName); %> </strong>Your Account Balance :</h3>
		<div class="row products_grids text-center mt-5">
			<div class="col-md-12 col-6 grid4">
				<div style="background-color:#ffc168"class="prodct1 border p-3">
					
					<i style="color:black;"class="fa fa-inr"></i>
						<h3 style="color:black;" class="mt-2" > <%out.print(balance); %></h3>
