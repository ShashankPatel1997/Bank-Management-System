 ...
 */
public class LoanMail extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String subject="DO NOT REPLY: ABC BANK Loan Success"; // mail subject line
		String msg="Thanks for Showing Your Intrest for Loan "+name+" Have a great Day.\nRegards\nABC BANK"; //mail body
...
//			message.setSubject(subject);
		...
		response.sendRedirect("/AbcBank/loanSuccess.jsp");
		}
		catch(Exception e)
		{
			e.printStackTrace();
